...
dirI <- "z:\\data_repo\\field_data\\bewkes\\TIM\\leaf\\csv"

#subset csv

dirS <- "z:\\projects\\thermal_canopy\\bewkes\\leaf_temp\\subset"

#output subsetted images
outS <- "z:\\projects\\thermal_canopy\\bewkes\\leaf_temp\\subset_out\\image"
#subset csv
outD <- "z:\\projects\\thermal_canopy\\bewkes\\leaf_temp\\subset_out"

#######################################
#####read in data                 ##### 
#######################################
#read in picture descriptions
descD <- read.csv("z:\\data_repo\\field_data\\bewkes\\TIM\\leaf\\Photolog.csv")
